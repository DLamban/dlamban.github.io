...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ui_ui_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./ui/ui.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_ui_ui_component__WEBPACK_IMPORTED_MODULE_1__["UiComponent"], _engine_engine_component__WEBPACK_IMPORTED_MODULE_2__["EngineComponent"]],
      encapsulation: 2
    });
    /*@__PURE__*/
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _engine_profilepic_profilepic_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./engine/profilepic/profilepic.component */
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _engine_engine_component__WEBPACK_IMPORTED_MODULE_3__["EngineComponent"], _engine_profilepic_profilepic_component__WEBPACK_IMPORTED_MODULE_9__["ProfilepicComponent"], _ui_ui_component__WEBPACK_IMPORTED_MODULE_8__["UiComponent"], _ui_ui_infobar_bottom_ui_infobar_bottom_component__WEBPACK_IMPORTED_MODULE_4__["UiInfobarBottomComponent"], _ui_ui_infobar_top_ui_infobar_top_component__WEBPACK_IMPORTED_MODULE_5__["UiInfobarTopComponent"], _ui_ui_sidebar_left_ui_sidebar_left_component__WEBPACK_IMPORTED_MODULE_6__["UiSidebarLeftComponent"], _ui_ui_sidebar_right_ui_sidebar_right_component__WEBPACK_IMPORTED_MODULE_7__["UiSidebarRightComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppEngineEngineComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _profilepic_profilepic_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./profilepic/profilepic.component */
    "./src/app/engine/profilepic/profilepic.component.ts");
    ...
    EngineComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 0,
      consts: [[1, "engine-wrapper"], ["width", "600", "height", "300", "id", "renderCanvas"], ["rendererCanvas", ""]],
      ...
      directives: [_profilepic_profilepic_component__WEBPACK_IMPORTED_MODULE_2__["ProfilepicComponent"]],
  ...
  function srcAppEngineEngineServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var three_examples_jsm_WebGL_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! three/examples/jsm/WebGL.js */
    "./node_modules/three/examples/jsm/WebGL.js");

    var fontJson = __webpack_require__(
    /*! ./../../assets/fonts/aldoapache.typeface.json */
    ...
    var EngineService = /*#__PURE__*/function () {
      ...
      _createClass(EngineService, [{
        ...
        value: function createScene(canvas) {
          ...
          console.log(canvas); // The first step is to get the reference of the canvas element from our HTML document
          ...
          this.scene = new three__WEBPACK_IMPORTED_MODULE_0__["Scene"](); // this.camera = new THREE.OrthographicCamera( window.innerWidth / - 2, window.innerWidth / 2, window.innerHeight / 2, window.innerHeight / - 2, 1, 1000 );
          ...
          var texture = loader.load('./../../assets/pics/profilepic.png');
          ...
          var textureCRTAmstrad = loader.load('./../../assets/pics/amstradcutted.png');
          ...
          this.materialBack = new three__WEBPACK_IMPORTED_MODULE_0__["ShaderMaterial"]({
            uniforms: this.uniforms,
            vertexShader: shader.trim(),
            fragmentShader: fs.trim()
          });
          var plane = new three__WEBPACK_IMPORTED_MODULE_0__["PlaneBufferGeometry"](10, 10);
          plane.scale(1.5, 1.5, 1);
          var material2 = new three__WEBPACK_IMPORTED_MODULE_0__["MeshBasicMaterial"]({
            color: 0x222222
          });
          var font = new three__WEBPACK_IMPORTED_MODULE_0__["Font"](fontJson);
          var textGeo = new three__WEBPACK_IMPORTED_MODULE_0__["TextGeometry"]("Fullstack Developer", {
            font: font,
            size: 0.5,
            height: 0.1
          });
          this.cube = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](textGeo, [this.material, material2]); // this.cube.scale.set(0.5,0.5,1);

          this.planeBack = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](plane, this.materialBack); // this.cube = new THREE.Mesh( geometry, this.material );
          ...
          this.cube.position.set(-2.5, 0, -2); //this.planeBack.position.set(0,0,-2);
          // this.scene.add(this.planeBack);

          this.scene.add(this.cube); //var axesHelper = new THREE.AxesHelper( 5 );
          //this.scene.add( axesHelper );

          var planeHelp = new three__WEBPACK_IMPORTED_MODULE_0__["Plane"](new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"](1, 1, 0.2), 3);
          var helper = new three__WEBPACK_IMPORTED_MODULE_0__["PlaneHelper"](planeHelp, 1, 0xffffff); //this.scene.add( helper );

          this.addSceneToRender({
            name: 'background',
            scene: this.scene,
            camera: this.camera
          });
        ...
        value: function render() {
          ...
          this.uniforms.iTime.value += 0.02; //console.log('render inside');
          //console.log(this.cube.material);
          // this.cube.rotation.x += 0.01;
          // this.cube.rotation.y += 0.01;

          this.renderAllscenes();
          console.log(window.innerHeight, window.innerWidth); //this.renderer.render(this.scene, this.camera);
        }
      }, {
        key: "addSceneToRender",
        value: function addSceneToRender(scene) {
          this.scenes.push(scene);
          console.log(this.scenes);
        }
      }, {
        key: "renderAllscenes",
        value: function renderAllscenes() {
          this.time += 0.1;
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              if (renderScene.name === 'background') {
                ...
                this.renderer.setViewport(800, 0, 200, 200); // renderScene.camera.lookAt((Math.sin(this.time)*0.01),0,0);
        ...
        value: function resize() {
          ...
          console.log("resizing", this.canvas.width); // this.renderer.setSize(width, height, false);
          //}
  ...
  /***/
  function srcAppEngineProfilepicProfilepicComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProfilepicComponent", function () {
    ...
    var _profilepic_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./profilepic.service */
    ...
    var ProfilepicComponent = /*#__PURE__*/function () {
      function ProfilepicComponent(profilepicService) {
    ...
    ProfilepicComponent.ɵfac = function ProfilepicComponent_Factory(t) {
      return new (t || ProfilepicComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_profilepic_service__WEBPACK_IMPORTED_MODULE_1__["ProfilepicService"]));
    };

    ProfilepicComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProfilepicComponent,
      selectors: [["app-profilepic"]],
      viewQuery: function ProfilepicComponent_Query(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstaticViewQuery"](_c0, true);
        }
      ...
      decls: 0,
      vars: 0,
      template: function ProfilepicComponent_Template(rf, ctx) {},
      encapsulation: 2
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfilepicComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: _profilepic_service__WEBPACK_IMPORTED_MODULE_1__["ProfilepicService"]
        }];
      }, {
        rendererCanvas: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
  ...
  /***/
  function srcAppEngineProfilepicProfilepicServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProfilepicService", function () {
      return ProfilepicService;
    });
    /* harmony import */
    ...
    var ProfilepicService = /*#__PURE__*/function () {
      function ProfilepicService(ngZone, engineService) {
        _classCallCheck(this, ProfilepicService);
      ...
      _createClass(ProfilepicService, [{
        key: "ngOnDestroy",
        value: function ngOnDestroy() {
          if (this.frameId != null) {
            cancelAnimationFrame(this.frameId);
        ...
        value: function createScene() {
          ...
          this.camera.position.z = 1;
          this.scene.add(this.camera); // const texture = loader.load('https://threejsfundamentals.org/threejs/resources/images/bayer.png');
          ...
          this.engineService.addSceneToRender({
            name: 'profile_pic',
            scene: this.scene,
            camera: this.camera
          });
        ...
        key: "createAmstradPic",
        value: function createAmstradPic() {
          var loader = new three__WEBPACK_IMPORTED_MODULE_0__["TextureLoader"]();
          var textureAmstradCRT = loader.load('./../../assets/pics/amstradcutted.png');
          ...
          var plane2 = new three__WEBPACK_IMPORTED_MODULE_0__["PlaneBufferGeometry"](3, 3);
          var planeBack = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](plane2, material);
          return planeBack;
        }
      }, {
        key: "createProfilePic",
        value: function createProfilePic() {
          var loader = new three__WEBPACK_IMPORTED_MODULE_0__["TextureLoader"]();
          var texture = loader.load('./../../assets/pics/profilepic.jpg');
          ...
          var plane = new three__WEBPACK_IMPORTED_MODULE_0__["PlaneBufferGeometry"](1.8, 1.8);
        ...
        value: function render() {
          ...
          this.uniforms.iTime.value += 0.05; // if (this.uniforms.iTime.value>5) this.uniforms.iTime.value=0;
        }
      }]);
    ...
    ProfilepicService.ɵfac = function ProfilepicService_Factory(t) {
      return new (t || ProfilepicService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_engine_service__WEBPACK_IMPORTED_MODULE_2__["EngineService"]));
    };

    ProfilepicService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      token: ProfilepicService,
      factory: ProfilepicService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ProfilepicService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  /***/
  function srcAssetsFontsAldoapacheTypefaceJson(module) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Git\personal-webpage\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
